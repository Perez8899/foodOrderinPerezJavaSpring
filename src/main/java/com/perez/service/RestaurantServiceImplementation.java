...
import com.perez.reporsitory.AddressRepository;
import com.perez.reporsitory.RestaurantRepository;
...
public class RestaurantServiceImplementation implements RestaurantService{
  ...
  //  @Autowired
    ...
    //---------Method of Interface RestaurantRepository---------------
    @Override
    ...
    @Override
    public Restaurant updateRestaurant(Long restaurantId, CreateRestaurantRequest updatedReq) throws RestaurantException {
    ...
    public RestaurantDto addToFavorites(Long restaurantId,User user) throws RestaurantException {
        ...
        List<RestaurantDto> favorites = user.getFavorities();
